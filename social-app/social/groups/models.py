...
class Group(models.Model):
    ...
    description = models.TextField(blank=True, default='Group Description')
    description_html = models.TextField(blank=True, default='Group Description HTML', editable=False)
